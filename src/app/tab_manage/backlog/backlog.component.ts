...
import { DatabaseManager, ActiveFilter, QueryFilter, join_and, NotFilter, ScheduledFilter, DormantFilter, CompleteFilter } from 'src/app/core/providers/database_manager';
...
import { DiscreteDate, prior_to, DiscreteDateLevel, get_level, get_today, contains } from 'src/app/core/providers/discrete_date';
