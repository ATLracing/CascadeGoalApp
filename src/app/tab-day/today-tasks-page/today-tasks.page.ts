...
import { DatabaseManager, DateContainsFilter, DatePriorFilter, ActiveFilter, DateLevelFilter, join_and, CompleteFilter } from 'src/app/core/providers/database-manager';
...
import { ConfigureTgvPageSettings } from '../../core/components/configure-tgv-page/configure-tgv.page';
import { get_today, DiscreteDateLevel } from 'src/app/core/providers/discrete-date';
import { DatabaseInflator } from 'src/app/core/providers/database-inflator';
import { ContextDependentTaskAttributes, ContextDependentTaskAttributesTab } from '../../core/components/task-list-item/task-list-item.component';

@Component({
  selector: 'today-tasks-page',
  templateUrl: 'today-tasks.page.html',
  styleUrls: ['today-tasks.page.scss']
})

export class TodayTasksPage implements OnDestroy {
