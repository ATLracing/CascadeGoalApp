...
import { DatabaseManager, ActiveFilter, DatePriorFilter, DateContainsFilter, DateLevelFilter, join_and, CompleteFilter } from 'src/app/core/providers/database-manager';
...
import { DiscreteDateLevel, get_level, get_this_week, equals, get_today, contains } from 'src/app/core/providers/discrete-date';
...
@Component({
  selector: 'week-tasks-page',
  templateUrl: 'week-tasks.page.html',
  styleUrls: ['week-tasks.page.scss'],
  animations: [
    trigger('openClose', [
      // ...
      state('open', style({
