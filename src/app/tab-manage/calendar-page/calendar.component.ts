...
import { ActiveFilter, DatabaseManager, join_and, ScheduledFilter } from 'src/app/core/providers/database-manager';
import { contains, DiscreteDate, get_this_week, prior_to, week_offset_str } from 'src/app/core/providers/discrete-date';
