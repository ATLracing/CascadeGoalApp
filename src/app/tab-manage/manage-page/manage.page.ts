...
import { ManageSettings, SettingsComponent } from '../settings/settings';
...
import { ChangeWeekComponent } from 'src/app/core/components/change-week/change-week.component';
