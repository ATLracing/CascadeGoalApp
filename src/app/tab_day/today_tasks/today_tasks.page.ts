...
import { DatabaseManager, DateContainsFilter, DatePriorFilter, ActiveFilter, DateLevelFilter, join_and, CompleteFilter } from 'src/app/core/providers/database_manager';
...
import { ConfigureTgvPageSettings } from '../../core/components/configure_tgv/configure_tgv.page';
import { get_today, DiscreteDateLevel } from 'src/app/core/providers/discrete_date';
import { DatabaseInflator } from 'src/app/core/providers/database_inflator';
